...
> 
## Version 1.0.11388.1100 (validation)

*Published: July 2025*

In this update, we made the following changes:

- Resolved an issue that caused duplicate registrations in Azure Active Directory (AAD).  
- Optimized telemetry flow. 
